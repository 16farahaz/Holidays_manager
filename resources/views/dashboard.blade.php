                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-body text-start p-3 w-100">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        <p class="text-sm text-secondary mb-1">Employees in holidays </p>
                                        <h4 class="mb-2 font-weight-bold">5</h4>
                                        <div class="d-flex align-items-center">
                                            <span class="text-sm text-success font-weight-bolder">
                                                <i class="fa fa-chevron-up text-xs me-1"></i>10.5%
                                            </span>
                                            <span class="text-sm ms-1">Coming Back in 18 dayes</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-body text-start p-3 w-100">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        <p class="text-sm text-secondary mb-1">Actual Workers </p>
                                        <h4 class="mb-2 font-weight-bold">276</h4>
                                        <div class="d-flex align-items-center">
                                            <span class="text-sm text-success font-weight-bolder">
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-body text-start p-3 w-100">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        <p class="text-sm text-secondary mb-1">Holidays with salary </p>
                                        <h4 class="mb-2 font-weight-bold">payed</h4>
                                        <div class="d-flex align-items-center">
                                            <span class="text-sm text-success font-weight-bolder">
                                                <i class="fa fa-chevron-up text-xs me-1"></i>100%
                                            </span>
                                            <span class="text-sm ms-1"> $369.30</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-body text-start p-3 w-100">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        <p class="text-sm text-secondary mb-1">Forms to check </p>
                                        <h4 class="mb-2 font-weight-bold">10</h4>
                                        <div class="d-flex align-items-center">
                                            <span class="text-sm text-success font-weight-bolder">
                                                <i class="fa fa-chevron-up text-xs me-1"></i>5%
                                            </span>
                                            <span class="text-sm ms-1">Holidays for last month</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card shadow-xs border">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center mb-3">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Recent Holidays</h6>
                                    <p class="text-sm mb-sm-0 mb-2">These are details about the Workers Forms </p>
                                </div>
                                ...
                                <table class="table align-items-center justify-content-center mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2">
                                                    <div class="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                                                        <img src="../assets/img/logoo.jpeg"
                                                            class="w-80" alt="spotify">
                                                    </div>
                                                    <div class="my-auto">
                                                        <h6 class="mb-0 text-sm">Farah Azizi </h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <span class="text-sm font-weight-normal">Wed 30 / 5 / 2025</span>
                                            </td>
                                            <td class="align-middle">
                                                <div class="d-flex">
                                                   
                                                    <div class="ms-2">
                                                        <p class="text-dark text-sm mb-0">Summer Holiday</p>
                                                        <p class="text-secondary text-sm mb-0">Expiry 30/06/2025</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="align-middle">
