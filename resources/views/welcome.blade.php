                            ...
                            <div class="card card-plain mt-8">
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-4 text-xs mx-auto">
                                        ...
                                        <a href="{{ route('signup') }}" class="text-dark font-weight-bold">Sign up</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="position-absolute w-40 top-0 end-0 h-100 d-md-block d-none">
                                <div class="oblique-image position-absolute fixed-top ms-auto h-100 z-index-0 bg-cover ms-n8"
                                    ...
                                    <div
                                        ...
                                        <h2 class="mt-3 text-dark font-weight-bold">Bizerte Cements</h2>
                                        <h6 class="text-dark text-sm mt-5">Copyright © 2025 Bizerte Ciments. All rights reserved.
                                            <br>Designed by
                                            Farah Azizi.</h6>
                                           </h6>
                                    </div>
